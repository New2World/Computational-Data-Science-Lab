...
public class Policy{
	...
	public static class Greedy_time implements Command
    {
        ...
        {
			ArrayList<Integer> result=new ArrayList<Integer>();
			reverse_greedy_k_lazy_time(network, diffusionState, result, k);
			//simu_greedy_1(network, diffusionState, result);
			return result;
        }
    }
    ...
    {
		public ArrayList<Integer> compute_seed_set(Network network, DiffusionState diffusionState, int nothing)
        {
	...
	public static double reverse_greedy_k_lazy(Network network, DiffusionState diffusionState, ArrayList<Integer> result, int k)
    {
        ...
        // Tools.printElapsedTime(startTime, endTime, "mymap push_back");
	...
	public static double reverse_greedy_k_lazy_time(Network network, DiffusionState diffusionState, ArrayList<Integer> result, int k)
    {
    	//System.out.println("reverse_greedy_k_lazy starts");
    	double profit=0;
    	//int rr_size=100000;
